 ...
 * Apply Conflict Signals indexes.

 * Usage: npx tsx scripts/apply-conflict-signals-indexes.ts
...
const sqlPath = path.join(__dirname, "..", "sql", "conflict_signals_indexes.sql");
